...
[Click here to finish setting up your workspace!](https://staging.nx.app/connect/sGzMDgQAqI)
...
```sh
npx nx serve clickup-cloud-db-issues
```

To create a production bundle:

```sh
npx nx build clickup-cloud-db-issues
```

To see all available targets to run for a project, run:

```sh
npx nx show project clickup-cloud-db-issues
```
